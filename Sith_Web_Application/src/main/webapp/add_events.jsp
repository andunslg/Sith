        ...
        <div class="content">
            <table>
                <tr>
                    ...
                    <td>
                        <div>
                            <input id="eventName" value="" type="text">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div>
                            <input id="statTime" value="" type="text">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div>
                            <input id="endTime" value="" type="text">
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <input id="location" value="" type="text">
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <input id="perceptionSchema"value="" type="text">
                        </div>
                    </td>
                </tr>
            </table>
            <div>
                <input id="add" value="Add" type="button" class="button">
            </div>
        </div>
    </section>
</section>
