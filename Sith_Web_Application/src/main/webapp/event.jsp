...
<%
    ...
    if(request.getParameter("eventID")!=null){
        currentEvent=sithAPI.getEvent(request.getParameter("eventID").toString());
        session.setAttribute("eventID",currentEvent.getEventID());
    }
    else{
        currentEvent=sithAPI.getEvent(session.getAttribute("eventID").toString());
    }
...
<section class="widget" height="100">
    ...
    <div class="row-fluid" align="center">
        <div id="toggle1" class="span2 offset1">
            <img class="thumbnail" style="width: 80px;height: 80px" src="images/perceptions/excited.png" title="Happy">
        </div>
        <div id="toggle2" class="span2" >
            <img class="thumbnail" src="images/perceptions/happy.png" style="width: 80px;height: 80px" title="Interested">
        </div>
