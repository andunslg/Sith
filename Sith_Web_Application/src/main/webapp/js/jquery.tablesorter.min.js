(function ($) {
    $.extend({tablesorter: new
        function () {
            var parsers = [], widgets = [];
            this.defaults = {cssHeader: "header", cssAsc: "headerSortUp", cssDesc: "headerSortDown", cssChildRow: "expand-child", sortInitialOrder: "asc", sortMultiSortKey: "shiftKey", sortForce: null, sortAppend: null, sortLocaleCompare: true, textExtraction: "simple", parsers: {}, widgets: [], widgetZebra: {css: ["even", "odd"]}, headers: {}, widthFixed: false, cancelSelection: true, sortList: [], headerList: [], dateFormat: "us", decimal: '../../default.htm|\,/g', onRenderHeader: null, selectorHeaders: 'thead th', debug: false};
    ...
    ts.addParser({id: "isoDate", is: function (s) {
        ...
        return $.tablesorter.formatFloat((s != "") ? new Date(s.replace(new RegExp(/-/g), "../../default.htm")).getTime() : "0");
    }, type: "numeric"});
